...
export class GdmLiveAudioVisuals extends LitElement {
  ...
  // Changed to protected to match LitElement lifecycle visibility
  protected firstUpdated() {
    // Fix: Access shadowRoot via any cast to resolve TypeScript error in LitElement
  ...
  // Changed to protected to resolve private visibility error on class extension
  protected render() {
